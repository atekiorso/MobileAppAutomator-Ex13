...
public abstract class CoreTestCase extends TestCase {
    ...
    private DesiredCapabilities getAndroidCapabilities() {
        ...
        capabilities.setCapability(MobileCapabilityType.APP, "/Users/admin/IdeaProjects/MobileAppAutomator/MobileAppAutomator-Ex13/apks/org.wikipedia.apk");
    ...
    private DesiredCapabilities getIOSCapabilities() {
        ...
        capabilities.setCapability(MobileCapabilityType.ORIENTATION, "PORTRAIT");
        capabilities.setCapability(MobileCapabilityType.APP, "/Users/admin/IdeaProjects/MobileAppAutomator/MobileAppAutomator-Ex13/apks/wikipedia.app");
